...
export const SetpointControl = ({
  ...
  const outputPercentage = range > 0 ? ((actualPower - pmin) / range) * 100 : 0;

  return (
    <div className="w-[150px]">
      <div className="relative flex h-5 w-full items-center">
        <Slider value={[value]} onValueChange={onValueChange} onValueCommit={onValueCommit} min={pmin} max={pmax} step={1} disabled={disabled} />
