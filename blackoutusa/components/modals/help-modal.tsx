  ...
  },
  {
    ...
    content: (
      <>
        ...
        <div className="my-4"><Image src="/Figs/Gen-in-service.PNG" alt="Interface showing a generator unit in service. It includes a green 'IN-SERVICE' badge, a slider for adjusting power output, and a bar showing actual output versus the setpoint." width={674} height={134} className="border border-white max-w-full h-auto" /></div>
        ...
        <div className="my-4"><Image src="/Figs/Gen-out-of-service.PNG" alt="Interface showing a generator unit out of service. It includes a gray 'OUT-OF-SERVICE' badge and a 'Start Up' button to begin bringing the unit online." width={674} height={134} className="border border-white max-w-full h-auto" /></div>
        ...
        <div className="my-4"><Image src="/Figs/Gen-start-up.PNG" alt="Interface showing a generator unit starting up. It includes a pulsing yellow 'STARTING UP' badge and a circular countdown timer showing the time remaining until the unit is synchronized with the grid." width={674} height={134} className="border border-white max-w-full h-auto" /></div>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <div className="my-4"><Image src="/Figs/Clock.PNG" alt="The game's time management interface, displaying the current simulation time and controls to adjust the game speed or pause the simulation." width={248} height={118} className="border border-white max-w-full h-auto" /></div>
